...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblCasilla.setForeground(new java.awt.Color(0, 0, 0));
        lblCasilla.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblCasilla.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 153, 255)));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lblCasilla, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblCasilla, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        this.firstNum= Float.parseFloat(this.lblCasilla.getText());
        this.operador="+";
        this.lblCasilla.setText("");
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        // TODO add your handling code here:
        this.secNum= Float.parseFloat(this.lblCasilla.getText());
        switch(this.operador) {
            case "+" -> this.lblCasilla.setText(sinCero(this.firstNum+ this.secNum));
            case "-" -> this.lblCasilla.setText(sinCero(this.firstNum- this.secNum));
            case "*" -> this.lblCasilla.setText(sinCero(this.firstNum* this.secNum));
            case "/" -> this.lblCasilla.setText(sinCero(this.firstNum/ this.secNum));
        }
    ...
    public String sinCero(float res) {
        String retorno=Float.toString(res);
        if (res%1==0) {
